...
function! PdbMapKeyboard()
	...
	autocmd BufRead *.py map <buffer> <silent> <F5> :call PdbStartDebug(1, [])<CR>
	" Start debug and don't pause immediately.
	autocmd BufRead *.py map <buffer> <silent> <C-F5> :call PdbStartDebug(0, [])<CR>
	autocmd BufRead *.py map <buffer> <silent> <C-S-F5> :call PdbStartDebugWithArguments
	autocmd BufRead *.py map <buffer> <silent> <S-F5> :call PdbStopDebug()<CR>
	autocmd BufRead *.py map <buffer> <silent> <C-A-S-F5> :call PdbRestartDebug()<CR>

	autocmd BufRead *.py map <buffer> <silent> <LocalLeader>l :call PdbLoadSavedBreakpoints()<CR>
	autocmd BufRead *.py map <buffer> <silent> <LocalLeader>s :call PdbSaveSavedBreakpoints()<CR>

	autocmd BufRead *.py map <buffer> <silent> <F7> :call PdbStepInto()<CR>
	autocmd BufRead *.py map <buffer> <silent> <F8> :call PdbStepOver()<CR>
	autocmd BufRead *.py map <buffer> <silent> <C-F8> :call PdbContinueUntilReturn()<CR>

	autocmd BufRead *.py map <buffer> <silent> <F9> :call PdbMoveUpInStackFrame()<CR>
	autocmd BufRead *.py map <buffer> <silent> <F10> :call PdbMoveDownInStackFrame()<CR>

	autocmd BufRead *.py map <buffer> <silent> <F6> :call PdbSetFocusToCurrentDebugLine()<CR>
	autocmd BufRead *.py map <buffer> <silent> <C-F6> :call PdbJumpToCurrentLine()<CR>

	autocmd BufRead *.py map <buffer> <silent> <F2> :call PdbToggleBreakpointOnCurrentLine()<CR>
	autocmd BufRead *.py map <buffer> <silent> <C-F2> :call PdbToggleConditionalBreakpointOnCurrentLine()<CR>
	autocmd BufRead *.py map <buffer> <silent> <S-F2> :call PdbToggleTemporaryBreakpointOnCurrentLine()<CR>
	autocmd BufRead *.py map <buffer> <silent> <C-S-F2> :call PdbClearAllBreakpointsInCurrentFile()<CR>
	autocmd BufRead *.py map <buffer> <silent> <C-A-S-F2> :call PdbClearAllBreakpoints()<CR>

	autocmd BufRead *.py map <buffer> <silent> <F11> :call PdbPrintBreakpointConditionOnCurrentLine()<CR>

	autocmd BufRead *.py map <buffer> <silent> <F4> :call PdbEvalCurrentWord()<CR>
	autocmd BufRead *.py map <buffer> <silent> <C-F4> :call PdbEvalCurrentWORD()<CR>

	autocmd BufRead *.py map <buffer> <silent>autocmd BufRead *.py  <F3> :call PdbEvalExpression()<CR>
	autocmd BufRead *.py map <buffer> <silent>autocmd BufRead *.py  <C-F3> :call PdbExecStatement()<CR>

	autocmd BufRead *.py map <buffer> <silent> <F12> :call PdbPrintStackTrace()<CR>
endfunction
